...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        ########## FORWARDPASS ##########
        # (1) affine transform to get initial hidden state
        ...
        ########## BACKWARDPASS ##########
        # initialize grads dict with same keys as params dict
        grads = dict.fromkeys(self.params)
        # backprop (4)
        dh, dW_vocab, db_vocab = temporal_affine_backward(dscores, cache_temp)
        # backprop (3)
        if self.cell_type == "rnn":
        ...
        # backprop (1)
        dfeats, dW_proj, db_proj = affine_backward(dh0, cache)
